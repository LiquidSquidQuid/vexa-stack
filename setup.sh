...
echo -e "${BOLD}║${NC}     ${GREEN}Required: ~7 GB${NC}  ${DIM}| Optional: +15 GB | Total: ~22 GB${NC}    ${BOLD}║${NC}"
echo -e "${BOLD}║${NC}                                                               ${BOLD}║${NC}"
...
echo -e "${BOLD}║${NC}     ${GREEN}Required: ~35 GB${NC} ${DIM}| Optional: +44 GB | Total: ~79 GB${NC}    ${BOLD}║${NC}"
echo -e "${BOLD}║${NC}                                                               ${BOLD}║${NC}"
...
echo -e "${BOLD}║${NC}     ${GREEN}Required: ~42 GB${NC} ${DIM}| Optional: +59 GB | Total: ~101 GB${NC}   ${BOLD}║${NC}"
echo -e "${BOLD}║${NC}                                                               ${BOLD}║${NC}"
echo -e "${BOLD}╚═══════════════════════════════════════════════════════════════╝${NC}"
